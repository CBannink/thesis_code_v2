...
from .development_module_visualization import (plot_cluster_whole,
                            ...
                            plot_simulation_flow_random_on_grid,adjusted_plot_quiver)
...
class Oracle_visualization:
    ...
    def plot_adjusted_quiver(self, pca_embedding, delta_embedding, primary_index, adata, n_neighbors=15, min_dist=0.1, random_state=42, umap_embedding=None, reducer = None):
        adjusted_plot_quiver(self, pca_embedding=pca_embedding, delta_embedding= delta_embedding, primary_index= primary_index,adata= adata,n_neighbors= n_neighbors, min_dist=min_dist, random_state=random_state, umap_embedding=umap_embedding, reducer=reducer)
